...
EGIT_DOC(pathspec_match_list_entry, "PATHSPEC-MATCH-LIST POSITION",
         ...
         "`libgit2-pathspec-match-diff'. If so, it will always return nil.");
...
EGIT_DOC(pathspec_match_list_diff_entry, "PATHSPEC-MATCH-LIST POSITION",
         ...
         "`libgit2-pathspec-match-diff'. Otherwise it will always return nil.");
...
EGIT_DOC(pathspec_match_workdir, "REPO FLAGS PATHSPEC",
         ...
         "`libgit2-pathspec-match-list-entrycount' will indicate 0 matches.\n"
         "  - find-failures: means that the `libgit2-pathspec-match-list' object "
         "should track which patterns matched which files so that at the end of "
         "the match we can identify patterns that did not match any files.\n"
         "  - failures-only: means that the `libgit2-pathspec-match-list' object "
