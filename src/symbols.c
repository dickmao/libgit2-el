...
void esyms_init(emacs_env *env)
{
    ...
    esym_libgit_annotated_commit_p = env->make_global_ref(env, env->intern(env, "libgit2-annotated-commit-p"));
    esym_libgit_blame_hunk_p = env->make_global_ref(env, env->intern(env, "libgit2-blame-hunk-p"));
    esym_libgit_blame_p = env->make_global_ref(env, env->intern(env, "libgit2-blame-p"));
    esym_libgit_blob_p = env->make_global_ref(env, env->intern(env, "libgit2-blob-p"));
    esym_libgit_commit_p = env->make_global_ref(env, env->intern(env, "libgit2-commit-p"));
    esym_libgit_config_p = env->make_global_ref(env, env->intern(env, "libgit2-config-p"));
    esym_libgit_cred_p = env->make_global_ref(env, env->intern(env, "libgit2-cred-p"));
    esym_libgit_diff_binary_p = env->make_global_ref(env, env->intern(env, "libgit2-diff-binary-p"));
    esym_libgit_diff_delta_p = env->make_global_ref(env, env->intern(env, "libgit2-diff-delta-p"));
    esym_libgit_diff_hunk_p = env->make_global_ref(env, env->intern(env, "libgit2-diff-hunk-p"));
    esym_libgit_diff_line_p = env->make_global_ref(env, env->intern(env, "libgit2-diff-line-p"));
    esym_libgit_diff_p = env->make_global_ref(env, env->intern(env, "libgit2-diff-p"));
    esym_libgit_index_entry_p = env->make_global_ref(env, env->intern(env, "libgit2-index-entry-p"));
    esym_libgit_index_p = env->make_global_ref(env, env->intern(env, "libgit2-index-p"));
    esym_libgit_object_p = env->make_global_ref(env, env->intern(env, "libgit2-object-p"));
    esym_libgit_pathspec_match_list_p = env->make_global_ref(env, env->intern(env, "libgit2-pathspec-match-list-p"));
    esym_libgit_pathspec_p = env->make_global_ref(env, env->intern(env, "libgit2-pathspec-p"));
    esym_libgit_reference_p = env->make_global_ref(env, env->intern(env, "libgit2-reference-p"));
    esym_libgit_reflog_entry_p = env->make_global_ref(env, env->intern(env, "libgit2-reflog-entry-p"));
    esym_libgit_reflog_p = env->make_global_ref(env, env->intern(env, "libgit2-reflog-p"));
    esym_libgit_refspec_p = env->make_global_ref(env, env->intern(env, "libgit2-refspec-p"));
    esym_libgit_remote_p = env->make_global_ref(env, env->intern(env, "libgit2-remote-p"));
    esym_libgit_repository_p = env->make_global_ref(env, env->intern(env, "libgit2-repository-p"));
    esym_libgit_revwalk_p = env->make_global_ref(env, env->intern(env, "libgit2-revwalk-p"));
    esym_libgit_signature_p = env->make_global_ref(env, env->intern(env, "libgit2-signature-p"));
    esym_libgit_submodule_p = env->make_global_ref(env, env->intern(env, "libgit2-submodule-p"));
    esym_libgit_tag_p = env->make_global_ref(env, env->intern(env, "libgit2-tag-p"));
    esym_libgit_transaction_p = env->make_global_ref(env, env->intern(env, "libgit2-transaction-p"));
    esym_libgit_tree_p = env->make_global_ref(env, env->intern(env, "libgit2-tree-p"));
    esym_libgit_treebuilder_p = env->make_global_ref(env, env->intern(env, "libgit2-treebuilder-p"));
